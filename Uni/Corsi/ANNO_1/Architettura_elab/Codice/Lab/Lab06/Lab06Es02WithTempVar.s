...
mcm:
    ...
    mul t0, a0, a1
    sw t0, 0(sp) # devo salvarlo perché, con la chiamata mcd, t0 lo perderei. Lo piazzo nello stack
    
    jal mcd # non abbiamo bisogno di caricare i parametri perché sono già stati posizionati precedentemente (nel main)

    lw t0, 0(sp) # mi recupero dallo stack la variabile t0 che avevo salvato, per poterla sfruttare nella divisione
    div a0, t0, a0
